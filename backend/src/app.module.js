...
var delivery_entity_1 = require("./deliveries/delivery.entity");
var patient_module_1 = require("./patients/patient.module");
var medicine_module_1 = require("./medicines/medicine.module");
    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                typeorm_1.TypeOrmModule.forRoot({
                    ...
                    entities: [user_entity_1.User, patient_entity_1.Patient, medicine_entity_1.Medicine, delivery_entity_1.Delivery],
                    synchronize: true,
                }),
                auth_module_1.AuthModule,
                patient_module_1.PatientsModule,
                medicine_module_1.MedicinesModule,
