...
var DeliveriesService = function () {
    ...
    var DeliveriesService = _classThis = /** @class */ (function () {
        function DeliveriesService_1(delRepo, patRepo, medRepo) {
            this.delRepo = delRepo;
            this.patRepo = patRepo;
            this.medRepo = medRepo;
        }
        DeliveriesService_1.prototype.create = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var patient, medicine, delivery;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.patRepo.findOne({ where: { id: dto.patientId } })];
                        case 1:
                            patient = _a.sent();
                            return [4 /*yield*/, this.medRepo.findOne({ where: { id: dto.medicineId } })];
                        case 2:
                            medicine = _a.sent();
                            if (!patient || !medicine)
                            ...
                            return [4 /*yield*/, this.medRepo.save(medicine)];
                        case 3:
                            _a.sent();
                            delivery = this.delRepo.create({
                                patient: patient,
                                medicine: medicine,
                                cantidad: dto.cantidad,
                            });
                            return [2 /*return*/, this.delRepo.save(delivery)];
                    }
                });
            });
        };
        DeliveriesService_1.prototype.findAll = function () {
